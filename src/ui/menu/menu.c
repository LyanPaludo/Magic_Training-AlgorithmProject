...
void desenhar_menu(void) {
    //fontes
    ALLEGRO_FONT *fonte_titulo = obter_fonte("assets/fonts/Agbalumo-Regular.ttf", ALTURA_TELA * 0.12);
    ALLEGRO_FONT *fonte_opcoes = obter_fonte("assets/fonts/Tinos-Regular.ttf", ALTURA_TELA * 0.06);
...
void desenhar_config_popup(void) {
    ALLEGRO_FONT *fonte_opcoes        = obter_fonte("assets/fonts/Tinos-Regular.ttf", ALTURA_TELA * 0.06);
    ALLEGRO_FONT *fonte_opcoes_menores = obter_fonte("assets/fonts/Silkscreen-Regular.ttf", ALTURA_TELA * 0.042);
